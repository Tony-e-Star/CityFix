          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" id="auth-modal-screen">
            ...
            >
              ...
              <div className="space-y-4 pt-1">
                ...
                {authMode === "login" && (
                  <div className="text-[10px] text-text-muted text-center pt-2 font-mono border-t border-slate-100 dark:border-slate-800/50 mt-2">
                    💡 <span className="font-semibold">Quick Preview Access:</span><br />
                    Email: <span className="text-slate-800 dark:text-slate-200 font-bold">test@example.com</span><br />
                    Password: <span className="text-slate-800 dark:text-slate-200 font-bold">password123</span>
                  </div>
                )}
              </div>
            </motion.div>
